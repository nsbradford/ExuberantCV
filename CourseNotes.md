...
6.  Image Motion
  ...
  * 6B Optical flow
    ...
    * Dense Flow: Lucas and Kanade
      * Start by assuming all u and v values are the same over some small 5x5 window... eventually produce equivalent of second moment matrix from Harris Corner Detector, where eigenvectors and eigenvalues of M related to edge direction and magnitude
      * With RGB, provides more accurate gradients (changes in intensity will be quite correlated between channels)
