...
def fitRobustLines(img):
    ...
    cv2.line(img=img, pt1=(0, lanes.Constants.IMG_CUTOFF), pt2=(lanes.Constants.IMG_SCALED_HEIGHT, lanes.Constants.IMG_CUTOFF), color=(0,255,0), thickness=2)
...
def addLines(img):
    ...
    cv2.line(img=copy, pt1=(0, lanes.Constants.IMG_CUTOFF), pt2=(lanes.Constants.IMG_SCALED_HEIGHT, lanes.Constants.IMG_CUTOFF), color=(0,255,0), thickness=2)
    return copy
